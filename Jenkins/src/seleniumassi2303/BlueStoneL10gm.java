...
public class BlueStoneL10gm {
	public WebDriver driver;
	 ...
	 public void setExtent() {
	  ...
	  htmlReporter = new ExtentHtmlReporter("C:\\Users\\vkulageri\\git\\testyantra\\TestYantra\\Reports\\BlueStoneL10gm.html");
	  ...
	  else if (result.getStatus() == ITestResult.SKIP) 
	  {
	   test.log(Status.SKIP, "Test Case SKIPPED IS " + result.getName());
		  ...
		  test.log(Status.PASS, "TEST CASE PASSED IS " + result.getName()); // to add name in extent report
		   ...
		   String screenshotPath = BlueStoneL10gm.getScreenshot(driver, result.getName());
	...
	public void validate() throws InterruptedException {
		test = extent.createTest("BlueStoneL10gm");
		...
		boolean imagepresent = driver.findElement(By.id("9167")).isDisplayed();
